...
--
--  Les cours sont datés dynamiquement à partir de MAINTENANT (NOW())
--  afin que les offres "de ce soir" restent pertinentes après l'import.
--
--  ⚠️ SÉCURITÉ : les 2 comptes de test (lea@demo.fr / pro@demo.fr,
--  mot de passe demo1234) sont à SUPPRIMER avant l'ouverture au public :
--     DELETE FROM users WHERE email LIKE '%@demo.fr';
--  Aucun compte admin n'est seedé (à créer manuellement le moment venu).
-- ============================================================
...
INSERT INTO slots (partner_id, sport, titre, coach, date_debut, duree_min, prix_initial, prix_reduit, places_totales, places_restantes, image_url, statut) VALUES
 (1,'Yoga','Vinyasa Flow','Camille R.',DATE_ADD(NOW(), INTERVAL 90 MINUTE),60,18,8,14,5,'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&w=800&q=80','disponible'),
 (2,'CrossFit','WOD du soir','Marco T.',DATE_ADD(NOW(), INTERVAL 45 MINUTE),60,20,12,16,3,'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=800&q=80','disponible'),
 (3,'Pilates','Pilates Reformer','Julie B.',DATE_ADD(NOW(), INTERVAL 150 MINUTE),55,26,9,8,2,'https://images.unsplash.com/photo-1571902943202-507ec2618e8f?auto=format&fit=crop&w=800&q=80','disponible'),
 (4,'Boxe','Boxing Cardio','Sofiane K.',DATE_ADD(NOW(), INTERVAL 60 MINUTE),60,22,11,12,6,'https://images.unsplash.com/photo-1549719386-74dfcbf7dbed?auto=format&fit=crop&w=800&q=80','disponible'),
